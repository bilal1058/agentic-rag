...
if not st.session_state.get("user"):
    ...
    with auth_col2:
        ...
        if is_supabase_configured() and google_oauth_url:
            st.html(
                f"""
                <a href="{google_oauth_url}" target="_top" onclick="window.top.location.href='{google_oauth_url}'; return false;" style="text-decoration:none; display:flex; align-items:center; justify-content:center; gap:12px; width:100%; padding:11px 16px; background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.16); border-radius:12px; color:#f4f4f5; font-size:14px; font-weight:500; transition:all 0.2s ease; margin-bottom:12px; cursor:pointer;">
